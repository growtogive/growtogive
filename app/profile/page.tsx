...
export default function ProfilePage() {
  ...
  const fetchProfileAndListings = async () => {
    try {
      ...
      const churches = CHURCH_HIERARCHY[userCity] || ['Grace Family Church'];
      ...
      setFormData({
        ...
        churchName: currentUser.churchName || churches[0],
          ...
          {!isEditing ? (
            ...
            <form onSubmit={handleSaveProfile} className="space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-xs font-semibold text-slate-700 uppercase tracking-wider mb-1">Church Affiliation</label>
                  <select name="churchName" value={formData.churchName} onChange={handleInputChange} className="w-full px-3 py-2 border border-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 cursor-pointer bg-white">
