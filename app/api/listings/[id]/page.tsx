...
export default function ListingDetailPage() {
  ...
  // Calculate real reviews and ratings from database data
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans pb-16">
      ...
      <main className="w-full max-w-4xl mx-auto px-6 pt-10 space-y-8">
        ...
        {/* Review Form Integration Section */}
                ...
                realReviews.map((rev: any) => (
                  <div key={rev.id} className="bg-slate-50 border border-slate-200 rounded-2xl p-4">
                    <div className="flex justify-between items-center mb-1.5">
                      <span className="font-bold text-slate-900 text-sm">{rev.author?.name || 'Community Member'}</span>
